...
console.log('📄 Učitavam https://radio.hrt.hr/slusaonica/druga-brzina');
await page.goto('https://radio.hrt.hr/slusaonica/druga-brzina', {
...
if (result.mp3) {
  ...
  // 🔥 FIKSNA SLIKA umjesto HRT‑ove
      const tvgLogoUrl = 'https://raw.githubusercontent.com/malimujo/HRT-Druga-brzina/main/drugabrzina.png';

  const m3uContent = `#EXTM3U
#EXTINF:-1 tvg-logo="${tvgLogoUrl}" group-title="Slušaonica",${emisijaInfo}
${result.mp3}`;

  fs.writeFileSync('Druga_brzina.m3u', m3uContent);
...
fs.writeFileSync('Druga_brzina.m3u', fallbackContent);
